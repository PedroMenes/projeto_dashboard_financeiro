...
$pageTitle = 'Editar Meta — Controle Financeiro';
$user = currentUser();
$db   = getDB();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($erros)) {
        $stmt = $db->prepare("UPDATE metas SET nome=?, descricao=?, valor_alvo=?, valor_atual=?, prazo=? WHERE id=? AND usuario_id=?");
        $stmt->execute([
            $dados['nome'],
        ...
        header('Location: /projeto_dashboard_financeiro/metas/index.php?msg=editada');
        exit;
    }
}
...
<div class="container" style="max-width:600px;">
    ...
    <div class="mb-4">
        ...
        <h1 class="page-title mb-0">Editar Meta</h1>
    </div>
        ...
        <div class="card-body p-4">
            <form method="POST" novalidate>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-12 col-sm-6">
                        <label for="valor_atual" class="form-label fw-semibold">Valor Atual (R$)</label>
                        <div class="input-group">
                            <span class="input-group-text">R$</span>
